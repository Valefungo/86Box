...
#if CONFIG_I2C_BUS_SUPPORT_SOFTWARE
static EXT_RAM_BSS_ATTR i2c_bus_t s_i2c_bus[I2C_NUM_SW_MAX];                                            /*!< If software I2C is enabled, additional space is required to store the port. */
#else
static EXT_RAM_BSS_ATTR i2c_bus_t s_i2c_bus[I2C_NUM_MAX];
#endif
